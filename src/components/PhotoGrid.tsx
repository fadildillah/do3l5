...
export default function PhotoGrid({ photos, rollName, canEdit = false }: { photos: Photo[]; rollName: string; canEdit?: boolean }) {
            ...
            >
              {isFailed ? (
                <div style={{
                  ...
                  color: "var(--text-ghost)", fontFamily: "var(--font-mono)", fontSize: "10px"
                }}>
                  [BROKEN FRAME]
                </div>
              ) : (
